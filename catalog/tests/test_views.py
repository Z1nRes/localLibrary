...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        test_user1 = User.objects.create_user(username='testuser1', password='testik111')
        test_user2 = User.objects.create_user(username='testuser2', password='testik222')
    ...
    def test_forbidden_if_logged_in_but_not_correct_permission(self):
        login = self.client.login(username='testuser1', password='testik111')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 403)

    def test_logged_in_with_permission(self):
        login = self.client.login(username='testuser2', password='testik222')
        response = self.client.get(reverse('author-create'))
